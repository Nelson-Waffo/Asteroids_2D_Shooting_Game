/****************************************************************************
** Meta object code from reading C++ file 'PlayerRenderer.h'
**
...
#include <memory>
#include "../../Asteroids/PlayerRenderer.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'PlayerRenderer.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 15, 7), // "restart"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "PlayerRenderer\0restart\0"
};
...
void PlayerRenderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PlayerRenderer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (PlayerRenderer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayerRenderer::restart)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PlayerRenderer::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_PlayerRenderer.data,
    qt_meta_data_PlayerRenderer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
